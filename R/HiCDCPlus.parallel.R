...
HiCDCPlus.parallel <- function(gi_list, covariates = NULL, chrs = NULL, distance_type = "spline", model_distribution = "nb", binned = TRUE, 
    ...
    gi_list[chrs] <- parallel::parLapply(cl, gi_list[chrs], HiCDCPlus.chr,covariates=covariates,
