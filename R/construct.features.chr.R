...
#'features.
#'@examples df<-construct.features.chr(chrom='chr22',
#'gen='Hsapiens', gen_ver='hg19',sig=c('GATC','GANTC'),bin_type='Bins-uniform',
#'binsize=100000,wg_file=NULL)
#'@export

construct.features.chr <- function(chrom, gen = "Hsapiens", gen_ver = "hg19",
    ...
    # get chromosome size
    genome.chromSize <- get.chr.sizes(gen, gen_ver, chrom)[chrom]
    ...
    enzymeCutsites <- get.enzyme.cutsites(sig, gen, gen_ver, chrom)
